...
export const DialogContent = (props: DialogContentProps) => {
	const { id, className, containerClassName, children, style, zIndex = 1500 } = props
	...
	return (
		<FloatingPortal>
			<Overlay lockScroll zIndex={zIndex} open={status === 'open'} close={status === 'close'}>
				<FloatingFocusManager
					...
					modal={true}
				>
					<div className={classNames(styles['dialog'], [containerClassName])} ref={refs.setFloating} role="presentation">
						<div
